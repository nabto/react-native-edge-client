...
class EdgeClient: NSObject {
  ...
  func createNabtoClient(
    clientId: Double, resolve: RCTPromiseResolveBlock, reject: RCTPromiseRejectBlock
  ) {
    let client = Client()
  ...
  func clientSetLogLevel(
    clientId: Double, level: NSString, resolve: RCTPromiseResolveBlock,
  ...
  func clientCreateConnection(
    clientId: Double, connectionId: Double, resolve: RCTPromiseResolveBlock,
    reject: RCTPromiseRejectBlock
  ) {
  ...
  func connectionCreateStream(
    connectionId: Double, streamId: Double, resolve: RCTPromiseResolveBlock,
    reject: RCTPromiseRejectBlock
  ) {
  ...
  func connectionCreateCoap(
    connectionId: Double, coapId: Double, method: NSString, path: NSString,
  ...
  func connectionCreateTcpTunnel(
    connectionId: Double, tcpTunnelId: Double, resolve: RCTPromiseResolveBlock,
    reject: RCTPromiseRejectBlock
  ) {
    let conn = getConnection(connectionId)
    do {
  ...
  func connectionUpdateOptions(
    connectionId: Double, options: NSString, resolve: RCTPromiseResolveBlock,
    reject: RCTPromiseRejectBlock
  ) {
    let conn = getConnection(connectionId)
    do {
  ...
  func connectionConnect(
    connectionId: Double, resolve: @escaping RCTPromiseResolveBlock,
  ...
  func connectionGetDeviceFingerprint(
    connectionId: Double, resolve: RCTPromiseResolveBlock, reject: RCTPromiseRejectBlock
  ) {
    let conn = getConnection(connectionId)
    do {
  ...
  func connectionGetClientFingerprint(
    connectionId: Double, resolve: RCTPromiseResolveBlock, reject: RCTPromiseRejectBlock
  ) {
    let conn = getConnection(connectionId)
    do {
  ...
  func connectionPasswordAuthenticate(
    ...
    let conn = getConnection(connectionId)
    conn.passwordAuthenticateAsync(username: username as String, password: password as String) {
      error in
      if error == NabtoEdgeClientError.OK {
        resolve(nil)
      } else {
  ...
  func streamOpen(
    streamId: Double, streamPort: Double, resolve: @escaping RCTPromiseResolveBlock,
    reject: @escaping RCTPromiseRejectBlock
  ) {
  ...
  func streamReadSome(
    streamId: Double, resolve: @escaping RCTPromiseResolveBlock,
    reject: @escaping RCTPromiseRejectBlock
  ) {
    let stream = getStream(streamId)
  ...
  func streamReadAll(
    streamId: Double, length: Double, resolve: @escaping RCTPromiseResolveBlock,
    reject: @escaping RCTPromiseRejectBlock
  ) {
    let stream = getStream(streamId)
  ...
  func streamWrite(
    streamId: Double, bytesBase64: NSString, resolve: @escaping RCTPromiseResolveBlock,
    reject: @escaping RCTPromiseRejectBlock
  ) {
    let stream = getStream(streamId)
  ...
  func streamDispose(
    streamId: Double, resolve: RCTPromiseResolveBlock, reject: RCTPromiseRejectBlock
  ) {
  ...
  func coapSetRequestPayload(
    coapId: Double, contentFormat: Double, payloadBase64: NSString, resolve: RCTPromiseResolveBlock,
    reject: RCTPromiseRejectBlock
  ) {
    ...
    guard let data = Data(base64Encoded: payloadBase64 as String, options: .ignoreUnknownCharacters)
    else {
  ...
  func coapExecute(
    coapId: Double, resolve: @escaping RCTPromiseResolveBlock,
    reject: @escaping RCTPromiseRejectBlock
  ) {
    guard let request = mCoapObjects[Int(coapId)] else {
      reject(reject_tag, "Coap object with id \(coapId) not found.", nil)
  ...
  func tcpTunnelOpen(
    tcpTunnelId: Double, service: NSString, localPort: Double,
    resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock
  ) {
  ...
  func tcpTunnelGetLocalPort(
    tcpTunnelId: Double, resolve: @escaping RCTPromiseResolveBlock,
    reject: @escaping RCTPromiseRejectBlock
  ) {
    let tunnel = getTunnel(tcpTunnelId)
    do {
  ...
  func tcpTunnelDispose(
    tcpTunnelId: Double, resolve: RCTPromiseResolveBlock, reject: RCTPromiseRejectBlock
  ) {
